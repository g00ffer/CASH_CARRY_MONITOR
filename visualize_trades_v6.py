...
def main():
    ...
    print("=" * 85)
    print("VISUALIZATION v6 — 8 графиков (best/worst pin + rails)")
    print("=" * 85)
    ...
    print(f"  scp gooffer@r1237472:~/cash-carry-monitor/visualizations_v6/*.png ~/Downloads/")
